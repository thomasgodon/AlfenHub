...
internal sealed class ChargerSnapshotBroadcaster : IChargerSnapshotBroadcaster
{
    ...
    private sealed class Subscription(ChargerSnapshotBroadcaster broadcaster, Guid id) : IDisposable
    {
